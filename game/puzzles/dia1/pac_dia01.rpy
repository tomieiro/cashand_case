...
#aqui usa %s
define pac1_img_saida = "images/inventario/finalizar.png"
...
default pac1_item_relogio = ["#000", "Um belo relógio. Parece funcional, apesar de estar 8 minutos atrasado.", False, 10, False, "IDE_ESCOLHEU_RELOGIO"]
default pac1_item_sangue = ["#f00", "Uma inscrição escrita em sangue, já seco. Me parece ser uma pista valiosa.", False, 11, False, "IDE_ESCOLHEU_SANGUE"]
...
label CHAMA_TELA_PAC_DIA1:
    ...
    show screen point_and_click_dia1() with puzzle_transition1

    jump POINT_AND_CLICK

label FIM_TELA_PAC_DIA1:
    hide screen point_and_click_dia1 with puzzle_transition1
    return
...
label PAC1_SELECIONA_ESTANTE:
    if(not pac1_item_sangue[2]):
        ...
        shp "Como não havíamos notado isso antes?"
...
label PAC1_SELECIONA_RELOGIO:
    ...
    show sheppard neutro onlayer screens at center with dissolve
    shp "Parece estar funcional, senhor Rightclue."
    drc "Correto. Todavia, encontra-se 8 minutos atrasado."
    shp "Talvez esteja com as pilhas ruins."
    drc "Certamente."
    hide sheppard onlayer screens with dissolve
