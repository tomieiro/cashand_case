label MENU_CONTAR_SHEPPARD:
    menu:
        ...
        "Arriscar e contar":
            ...
            drc "Com toda certeza. É óbvio que seria um dos herdeiros. O último herdeiro, que por falha, esqueci de perguntar à Martha de quem se tratava, desceu do quarto do senhor Hougin às duas e vinte nove."
            ...
            shp "Entendo. Agradeço pelo empenho detetive. Vou me retirar por hoje. Tentar digerir tudo isso. Amanhã logo cedo investigaremos os herdeiros. Descobriremos quem é esse maldito traidor!"
    ...
    "*Sheppard se retira. Tela escurece lentamente*"
    jump CENA21
