label INTRODUCAO_PERSONAGEM_CENA12(role):
    if(role[1] == "Joe"):
        ...
        shp "Joe é temperamental. Um pouco atacado pela soberba, mas é um bom rapaz, garanto ao senhor."
    elif(role[1] == "Hugo"):
        shp "Este era Hugo Theodore Cashand, segundo filho de Hougin."
        shp "Hugo não liga muito para etiqueta."
        shp "Hoje, ele vive com seu cachorro em uma Kombi, próximo à mansão."
