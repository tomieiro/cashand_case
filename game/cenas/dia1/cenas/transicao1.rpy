...
label TRANSICAO1:
    ...
    if cluepoints < 1:
        ...
        drc "Precisamente. Consegui pensar em várias situações se encaixando, várias pistas que podem levar a uma ideia inicial."
        ...
        shp "..."
        pause(2)
        shp "Eu já tive família, detetive. Esposa, um filho e uma filha."
        drc "E o que aconteceu?"
        shp "Antes de conhecer o senhor Hougin, eu era maquinista."
        shp "Saía todos os dias do trabalho e corria para casa com toda força que me restava. Minha família sempre foi a coisa mais importante para mim."
        shp "O amor, detetive, é o que nos dá forças todos os dias, para se levantar da cama, aguentar tudo que nos acontece, pois sabemos que, no final desses dias, aqueles sorrisos estarão lá, te esperando, te confortando."
        shp "Mas nada dura para sempre, senhor Rightclue. Seres humanos são falhos."
        shp "Naquele dia, naquele maldito dia, decidi que deveria fazer outro turno. Não avisei minha esposa e filhos, que, preocupados com minha ausência, saíram para me procurar."
        ...
        shp "Mas temos um caso aqui, detetive. Precisamos nos concentrar no presente."
