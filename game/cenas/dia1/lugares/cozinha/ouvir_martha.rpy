label OUVIR_MARTHA:
    ...
    drc "Sozinho?"
    mrth "Sim. Todavia, tenho conhecimento que todos os seus filhos o visitaram, separadamente, naquela noite, sendo o último tendo voltado às duas e vinte nove da manhã. O que levaria a crer que o assassinato ocorreu depois que todos estiveram lá."
    mrth "Não gosto de incriminar ninguém, senhor, mas tive conhecimento que às duas e trinta e um da manhã, uma pessoa externa subiu até o quarto do senhor Hougin."
    drc "Quem era?"
    ...
    mrth "Tínhamos acabado de voltar do funeral. O senhor Lostie se trocou e foi ao jardim fumar, como toda noite fazia."
